        ...
        if event["type"] == "message":
            if "subtype" in event:
                ...
                client.web_client.chat_postMessage(
                    channel = CHANNEL,
                    thread_ts = event["ts"],
                    text = "%s: if you'd like to report a bug, please fill out the form at *<https://forms.gle/edAKmJHDKj4LYVYE9>* and add as much information as possible. Thank you!" %(mention)
                )
